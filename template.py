...
# https://github.com/StoneIron02/Inha2022_OSS
...
def dataset_stat(dataset_df):
    size_by_class = dataset_df.groupby("target").size()
    size_features = dataset_df.shape[1] - 1
    return size_features, size_by_class[0], size_by_class[1]
